...
- **AND** plain local validation, when run, is separate machine-global comparison evidence and the no-active-change mode is not required at that checkpoint
...
- **AND** plain local validation remains separate machine-global comparison evidence only
...
- FROM: `### Requirement: Public documentation represents the released v0.4.18 state`
- TO: `### Requirement: Public documentation represents the released v1.0.0 state`
- FROM: `### Requirement: v1.0.0 development status remains separate from public v0.4.18`
- TO: `### Requirement: v1.0.0 public status supersedes public v0.4.18`

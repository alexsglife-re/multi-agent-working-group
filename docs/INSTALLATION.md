...
Release note: v1.0.0 adds Progressive Leader State Profiles without changing runtime installation paths or adapter maturity; no next development target is declared, publication is limited to the formal GitHub Release, and deployment was not performed.
